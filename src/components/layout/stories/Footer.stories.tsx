    ...
    <div className="min-h-screen flex flex-col w-full">
        <div className="flex-1 flex items-center justify-center p-8">
            <div className="max-w-2xl w-full text-center space-y-4">
                ...
                <h1 className="text-3xl font-bold text-foreground">Page de démonstration</h1>
        ...
        children: (
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 py-4 px-6 w-full">
                <span className="text-sm text-muted-foreground">
                    © 2026 Aurora UI. Tous droits réservés.
                </span>
        ...
        children: (
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 py-4 px-6 w-full">
                ...
                <div className="flex gap-4">
                    <a
                        href="#"
                        className="p-2 rounded-full text-muted-foreground hover:text-foreground hover:bg-muted/20 transition-colors"
                        aria-label="Twitter"
                    >
                        <TwitterIcon />
                    </a>
    ...
    args: {
        ...
        children: (
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 py-4 px-6 w-full">
                ...
                <span className="text-sm text-muted-foreground bg-primary/10 px-3 py-1 rounded-full flex items-center gap-1">
                    🪟 Transparent
                </span>
            </div>
        ),
